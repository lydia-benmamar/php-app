...
// And the dbname value (php_app_db) with your database name
define('DB_DSN', 'mysql:host=localhost;dbname=php_app_db');

// You need to replace root with the user name of the database
define('DB_USER', 'root');

// You need to add the user password of the database (Add this file name to.gitignore file before adding the password)
define('DB_PASS', '');
